...
public:
    ...
    Reg16 r16();        //Retourne un r16 associé à cette adresse
...
class Reg16 {
    ...
    public:
        ...
        operator unsigned short();        //Pour lire un registre 16 bits
};
...
class aff7seg {
    ...
    public :
        ...
        void affich(char data, bool hex = false);       // Affiche un nombre entier décimal ou hexadécimal
};
